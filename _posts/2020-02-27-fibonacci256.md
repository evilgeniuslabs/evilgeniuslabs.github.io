...
2. I used 90 degree header pins to allow connecting and disconnecting jumper wires easily.  I used small pieces of female headers to keep them level while I soldered
...
6. Check each solder joint, then disconnect the female headers and connect female jumper wires.
7. **VERY** carefully check polarity before connecting 5V and GND.  If possible, connect 5V and GND on both sets of headers to provide maximum current flow and minimize voltage drop.
