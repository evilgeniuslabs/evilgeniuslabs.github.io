...
1. Carefully flip the jib and base PCB over and make sure all of the pins came through the holes in the base without getting bent. Make sure the tabs on the jig are inserted into the slots on the base PCB.
...
The power jack connector goes on the bottom of the base, the opposite side as the sockets.

The JST-XH 3-Pin connector also goes on the bottom of the base on the "DIN" pins.
...
1. Insert four of the M3 x 15 + 6mm standoffs through the corner holes of the PCB into the clear acrylic corner "arrow" pieces. The holes in the corner pieces are *just* big enough that the standoffs with thread the acrylic. Very loosely hand-tighten them using a 5mm nut driver. We will tighten them later after the entire enclosure is assembled:
...
1. Work your way across the LED guide, inserting the next LED stick into the next slot.
