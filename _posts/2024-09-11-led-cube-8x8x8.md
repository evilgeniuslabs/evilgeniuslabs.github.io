...
**Note**: You can download and 3D print the following tools to make the process **much** easier:

* <a href="/downloads/led-cube-8x8x8/LED Cube 8x8x8 Stick Brake Set.stl">LED stick brake set</a>
* <a href="/downloads/led-cube-8x8x8/LED Cube 8x8x8 Base Soldering Jig.stl">Base connector soldering jig</a>

   <a href="/assets/CmSHQLW.jpg" target="_blank"><img src="/assets/CmSHQLW.jpg" style="width:340px" /></a>
...
1. Insert one row of the 2x2 header sockets into the base PCB, on the side with the square markings.
   ...
   <a href="/assets/O4MnmPw.jpg" target="_blank"><img src="/assets/O4MnmPw.jpg" style="width:340px" /></a>
   <a href="/assets/nOY5hkR.jpg" target="_blank"><img src="/assets/nOY5hkR.jpg" style="width:340px" /></a>
...
1. Your LED strips may come all connected in one PCB piece. If so, you'll need to carefully and gently separate them along the scored lines.
   ...
   <a href="/assets/gGqKGG5.jpg" target="_blank"><img src="/assets/gGqKGG5.jpg" style="width:340px" /></a>

1. I use a 3D printed "brake" set, a pair of handles that make it much easier to separate them by hand.

1. You can alternatively use a pair of needle-nose pliers with sections of heat-shrink tubing over the ends to protect the PCBs. Grip on one side of the score line with your fingers and the other gently with the padded pliers. DO NOT SQUEEZE THE PCBs OR LEDs TOO TIGHTLY!
...
1. Insert four of the M3 x 15 + 6mm standoffs through the corner holes of the PCB into the clear acrylic corner "arrow" pieces. The holes in the corner pieces are _just_ big enough that the standoffs will thread the acrylic. Just start each one, making sure they're all lined up, then gently hand-tighten them using a 5mm nut driver:
