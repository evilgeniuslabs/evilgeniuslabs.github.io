...
<img src="/assets/nExINgG.jpg" style="width:400px" class="img-responsive" />
...
<img src="/assets/8nYOC2B.jpg" style="width:400px" class="img-responsive" />
...
1. In the Arduino IDE, click the _Tools_ menu, then _Board_, then click _Teensy LC_.
2. Click the _Tools_ menu again, then _Port_, and then the port your Teensy LC is plugged in to.
3. Click the _Verify_ button (check mark) in the toolbar.
4. It should finish, and say _Done compiling_ in the status bar at the bottom of the window.
5. Now click the _Upload_ button (right arrow) in the toolbar.
